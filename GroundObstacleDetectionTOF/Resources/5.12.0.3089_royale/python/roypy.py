...
class ICameraDevicePtr(object):
    ...
    def getOutputResolution(self, outputResolution, streamId=0):
        return _roypy.ICameraDevicePtr_getOutputResolution(self, outputResolution, streamId)
...
class ICameraDevice(object):
    ...
    def getOutputResolution(self, outputResolution, streamId=0):
        return _roypy.ICameraDevice_getOutputResolution(self, outputResolution, streamId)
...
class RawData(object):
    ...
    chipLength = property(_roypy.RawData_chipLength_get, _roypy.RawData_chipLength_set)
    bitShifts = property(_roypy.RawData_bitShifts_get, _roypy.RawData_bitShifts_set)
    codeLength = property(_roypy.RawData_codeLength_get, _roypy.RawData_codeLength_set)
    ...
    def getPseudoDataFromPhase(self, idx):
        return _roypy.RawData_getPseudoDataFromPhase(self, idx)
...
EventType_ROYALE_INFO = _roypy.EventType_ROYALE_INFO
class IEvent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
